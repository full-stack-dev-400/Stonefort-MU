export default function Features04() {
  return (
    <section className="relative bg-[#101711]">
  ...
  <stop offset="0%" stopColor="#4D6E55" />
  <stop offset="100%" stopColor="#101711" stopOpacity="0" />
</linearGradient>
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          {/* Rows */}
          <div className="divide-y divide-[#1A231B]">
            {/* Row */}
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-[#4D6E55] to-[#87AB93] pb-6">
